...
//     className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-white text-gray-700 p-6 rounded-full shadow-lg hover:bg-gray-50 transition"
//     onClick={() => {
//       onClick();
...
//   !isEnd && (
//   <button
//     className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-white text-gray-700 p-6 rounded-full shadow-lg hover:bg-gray-50 transition"
//     onClick={() => {
//       onClick();
//       setTimeout(checkPosition, 200); // Delay check for smooth transition
//     }}
  ...
  return (
    <div className="flex items-center justify-center flex-col mb-5">
      <div className="w-5/6 mt-14">
        <h1 className="text-4xl font-bold mb-10">Top Universities/Colleges</h1>
      </div>
              ...
              <div className="w-full h-fit bg-white rounded-lg overflow-hidden border-2 border-gray-300">
                ...
                <div className="px-4 ">
                  <div className=" flex flex-row justify-between">
                    <h4 className=" text-gray-800 text-2xl font-semibold mt-2">
                      {i.program}
                    </h4>
                    <div className="flex items-center mt-2">
                      ...
                      <span className=" flex flex-row">
                        <p className="text-yellow-500 text-xl border-0 ring-0 shadow-none outline-none">
                          ⭐
                        </p>
